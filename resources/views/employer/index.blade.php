        ...
        <div class="container-fluid px-md-4	">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="{{ route('profileEmployer.index') }}" class="nav-link">Profile</a>
                    </li>
                    ...
                    <li class="nav-item cta mr-md-1"><a href="{{ route('employer.post_job') }}" class="nav-link">Post
                            Jobs</a></li>
                    <li class="nav-item cta mr-md-1"><a href="{{ route('employer.recharge') }}"
                            class="nav-link">Recharge
                        </a></li>
                    </a></li>
                    @if (!Auth::check())
                                ...
                                <div class="job-post-item p-4 d-block d-lg-flex align-items-center">
                                    <div class="one-third mb-4 mb-md-0">
                                        <div class="job-post-item-header align-items-center">
                                            ...
                                            <h2 class="mr-3 text-black" style="text-transform: uppercase"><a
                                                    href="#">{{ $job->title }}</a></h2>
                                        </div>
