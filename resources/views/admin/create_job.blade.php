        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-xlg-9 col-md-7">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-horizontal form-material mx-2" action="{{ route('job.store') }}"
                                method="POST">
                                @csrf
                                
                                <div class="form-group">
                                    <label class="col-sm-12">Select Employer Id</label>
                                    <div class="col-sm-12">
                                        <select class="form-select shadow-none form-control-line" name="employer_id">
                                            @foreach($employerId as $id)<option name="employer_id" value="{{ $id }}"> {{ $id }}</option> @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Fill title" class="form-control form-control-line"
                                            name="title" value="">
                                        @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Fill location"
                                            class="form-control form-control-line" value="" name="location">
                                        @error('location')
                                            <p style="color: #dd3675;padding-top:4px">* {{ $message }}</p>
                                        @enderror
                                    </div>
