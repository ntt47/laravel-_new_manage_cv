        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-xlg-9 col-md-7">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-horizontal form-material mx-2" action="{{ route('user.update', ['user' => $user->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="123 456 7890"
                                            class="form-control form-control-line" value="{{ $user->phone_number }}"
                                            name="phone_number">
                                        @error('phone_number')
                                            <p style="color: #dd3675;padding-top:4px">* {{ $message }}</p>
                                        @enderror
